...
<Columns cols={2}>
  <Card title="Authentication" icon="lock" href="/api/authentication" color="#3cbcab">
    Obtain and manage Bearer tokens for API access.
  </Card>
  <Card title="Courses" icon="book-open" href="/api/courses" color="#3cbcab">
    Create, read, update, and delete learning courses.
  </Card>
  <Card title="Users" icon="users" href="/api/users" color="#3cbcab">
    Manage learner and instructor accounts.
  </Card>
  <Card title="Enrollments" icon="user-check" href="/api/enrollments" color="#3cbcab">
    Enroll learners in courses and track progress.
  </Card>
  <Card title="Assessments" icon="clipboard-list" href="/api/assessments" color="#3cbcab">
